...
class IfixVpnService : VpnService() {
    ...
    companion object {
        const val ACTION_CONNECT = "com.ifixmobile.vpn.CONNECT"
        const val ACTION_DISCONNECT = "com.ifixmobile.vpn.DISCONNECT"
        const val EXTRA_CONFIG_URI = "config_uri"
        const val EXTRA_SERVER_NAME = "server_name"
        const val BROADCAST_STATE = "com.ifixmobile.vpn.STATE"
    ...
    private fun buildNotification(content: String): Notification {
        ...
        return NotificationCompat.Builder(this, CH_ID)
            .setContentTitle("IFIX Mobile VPN")
